            ...
            >
              ...
              <div className="space-y-3 mb-6">
                ...
                <button
                  ...
                  className="w-full py-3 px-4 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-3 hover:opacity-90"
                  style={{
                    fontFamily: "'Noto Sans JP', sans-serif",
                ...
                <button
                  type="button"
                  onClick={() => signIn("google", { callbackUrl: "/learner/dashboard" })}
                  className="w-full py-3 px-4 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-3 border-2 border-gray-200 bg-white hover:bg-gray-50"
                  style={{
                    fontFamily: "'Outfit', sans-serif",
                    color: "#333",
                  }}
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white text-gray-400" style={{ fontFamily: "'Outfit', sans-serif" }}>
                    or
                  </span>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  style={{
                    fontFamily: "'Outfit', sans-serif",
                    background: isSubmitHovered ? "#E65A2B" : "#FF6B35",
                    color: "white",
                  }}
                >
                  {loading ? (
